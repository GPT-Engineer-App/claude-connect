...
**Project**: claude-connect 

**URL**: https://run.gptengineer.app/projects/REPLACE_WITH_PROJECT_ID/improve

**Description**: Generate an interface simlair to the one on claude.ai which I can just paste my anthropic API key into and the version of claude and it will work. Do you understand what I want? 
...
```sh
git clone https://github.com/GPT-Engineer-App/claude-connect.git
cd claude-connect
npm i
